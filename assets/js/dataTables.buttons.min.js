...
(function (f) {
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables.net"], function (D) {
        return f(D, window, document);
      })
    : "object" === typeof exports
    ? (module.exports = function (D, z) {
        D || (D = window);
        (z && z.fn.dataTable) || (z = require("datatables.net")(D, z).$);
        return f(z, D, D.document);
      })
  ...
  var u = f.fn.dataTable,
    ...
    w = function (a, b) {
      ...
      this.c = f.extend(!0, {}, w.defaults, b);
  ...
  f.extend(w.prototype, {
    ...
    add: function (a, b, c) {
      ...
      if ("string" === typeof b) {
        ...
        var h = this.s;
        d = 0;
        for (var e = b.length - 1; d < e; d++) h = h.buttons[1 * b[d]];
        d = h.buttons;
        b = 1 * b[b.length - 1];
      }
      this._expandButton(
        ...
        a,
        a !== q ? a.split : q,
        (a === q || a.split === q || 0 === a.split.length) && h !== q,
        !1,
        b
      );
      (c !== q && !0 !== c) || this._draw();
      ...
      if (b !== q) {
        ...
        for (c = 0; c < b.length; c++) {
          ...
          this._expandButton(
            a.buttons,
            d,
            d !== q && d.config !== q && d.config.split !== q,
            !0,
            d.parentConf !== q && d.parentConf.split !== q,
            c,
            d.parentConf
          );
        }
    ...
    index: function (a, b, c) {
      ...
      for (var d = 0, h = c.length; d < h; d++) {
        ...
        if (e && e.length && ((e = this.index(a, d + "-", e)), null !== e))
          return e;
      }
      return null;
    },
    ...
    text: function (a, b) {
      ...
      var d = this.s.dt,
        h = f(c.node),
        e = function (g) {
          return "function" === typeof g ? g(d, h, c.conf) : g;
        };
      if (b === q) return e(c.conf.text);
      c.conf.text = b;
      a
        ? h.children(a).eq(0).filter(":not(.dt-down-arrow)").html(e(b))
        : h.html(e(b));
      return this;
    },
    _constructor: function () {
      ...
      for (var h = 0, e = d.length; h < e; h++) this.add(d[h]);
      b.on("destroy", function (g, m) {
        m === c && a.destroy();
      });
      f("body").on("keyup." + this.s.namespace, function (g) {
        if (!z.activeElement || z.activeElement === z.body) {
          var m = String.fromCharCode(g.keyCode).toLowerCase();
          -1 !== a.s.listenKeys.toLowerCase().indexOf(m) && a._keypress(m, g);
        }
      });
    },
    _addKey: function (a) {
    ...
    _expandButton: function (a, b, c, d, h, e, g) {
      ...
      b === q && (t = Array.isArray(c) ? c : [c]);
      c = 0;
      for (var r = t.length; c < r; c++) {
        var n = this._resolveExtends(t[c]);
        if (n)
          if (
            ((b = n.config !== q && n.config.split ? !0 : !1), Array.isArray(n))
          )
            this._expandButton(
              a,
              n,
              l !== q && l.conf !== q ? l.conf.split : q,
              d,
              g !== q && g.split !== q,
              e,
              g
            ...
            var l = this._buildButton(
              n,
              d,
              n.split !== q || (n.config !== q && n.config.split !== q),
              h
            );
            if (l) {
              e !== q && null !== e ? (a.splice(e, 0, l), e++) : a.push(l);
              if (l.conf.buttons || l.conf.split) {
                l.collection = f(
                  "<" +
                    (b
                ...
                if (l.conf.split)
                  for (var p = 0; p < l.conf.split.length; p++)
                    "object" === typeof l.conf.split[p] &&
                      ((l.conf.split[p].parent = g),
                      l.conf.split[p].collectionLayout === q &&
                        (l.conf.split[p].collectionLayout =
                          l.conf.collectionLayout),
                      l.conf.split[p].dropup === q &&
                        (l.conf.split[p].dropup = l.conf.dropup),
                      l.conf.split[p].fade === q &&
                        (l.conf.split[p].fade = l.conf.fade));
                else
                  f(l.node).append(
                    f(
              ...
              l.conf.parent = g;
              n.init && n.init.call(m.button(l.node), m, f(l.node), n);
              k++;
            }
          }
      }
    ...
    _buildButton: function (a, b, c, d) {
      var h = this.c.dom.button,
        ...
        m = this.c.dom.splitCollection,
        k = this.c.dom.splitDropdownButton,
        t = this.s.dt,
        r = function (v) {
          return "function" === typeof v ? v(t, l, a) : v;
        };
      if (a.spacer) {
        var n = f("<span></span>")
      ...
      !c && d && m ? (h = k) : !c && b && g.button && (h = g.button);
      !c && d && m.buttonLiner
        ? (e = m.buttonLiner)
        : !c && b && g.buttonLiner && (e = g.buttonLiner);
      if (a.available && !a.available(t, a) && !a.hasOwnProperty("html"))
        return !1;
      if (a.hasOwnProperty("html")) var l = f(a.html);
      else {
        var p = function (v, B, E, G) {
          G.action.call(B.button(E), v, B, E, G);
          f(B.table().node()).triggerHandler("buttons-action.dt", [
            B.button(E),
            B,
            E,
            G,
        ...
        g = a.tag || h.tag;
        var x = a.clickBlurs === q ? !0 : a.clickBlurs;
        l = f("<" + g + "/>")
          ...
          .on("click.dtb", function (v) {
            v.preventDefault();
            !l.hasClass(h.disabled) && a.action && p(v, t, l, a);
            x && l.trigger("blur");
          })
        ...
        e.tag
          ? ((g = f("<" + e.tag + "/>")
            ...
            l.append(g))
          : l.html(r(a.text));
        !1 === a.enabled && l.addClass(h.disabled);
        a.className && l.addClass(a.className);
        a.titleAttr && l.attr("title", r(a.titleAttr));
      ...
      if (c) {
        ...
        this._addKey(F);
        var C = function (v, B, E, G) {
            A.split.action.call(
              B.button(f("div.dt-btn-split-wrapper")[0]),
              v,
              B,
              E,
              G
          ...
          y = f(
            ...
            .on("click.dtb", function (v) {
              v.preventDefault();
              v.stopPropagation();
              y.hasClass(h.disabled) || C(v, t, y, F);
              x && y.trigger("blur");
            })
            .on("keypress.dtb", function (v) {
              13 === v.keyCode &&
                (v.preventDefault(), y.hasClass(h.disabled) || C(v, t, y, F));
            });
        0 === a.split.length && y.addClass("dtb-hide-drop");
        n.append(y).attr(F.attr);
      }
      return {
        conf: a,
        node: c ? n.get(0) : l.get(0),
        inserter: c ? n : e,
        buttons: [],
        inCollection: b,
        isSplit: c,
      ...
      if (!b._buttonsHandled) {
        var c = function (d) {
          for (var h = 0, e = d.length; h < e; h++) {
            ...
            g.key &&
              (g.key === a
                ? ((b._buttonsHandled = !0), f(m).click())
                : !f.isPlainObject(g.key) ||
                  g.key.key !== a ||
    ...
    _resolveExtends: function (a) {
        ...
        h = function (k) {
          for (var t = 0; !f.isPlainObject(k) && !Array.isArray(k); ) {
            ...
            if ("function" === typeof k) {
              if (((k = k.call(b, c, a)), !k)) return !1;
            } else if ("string" === typeof k) {
              if (!A[k]) return { html: k };
              k = A[k];
            }
            t++;
      ...
      for (a = h(a); a && a.extend; ) {
        ...
        a.config !== q &&
          e.config !== q &&
          (a.config = f.extend({}, e.config, a.config));
        a = f.extend({}, e, a);
        ...
        if (m) {
          a.buttons || (a.buttons = []);
          g = 0;
          for (d = m.length; g < d; g++) a.buttons.push(m[g]);
          a.postfixButtons = null;
        }
        if ((m = a.prefixButtons)) {
          a.buttons || (a.buttons = []);
          g = 0;
          for (d = m.length; g < d; g++) a.buttons.splice(g, 0, m[g]);
    ...
    _popover: function (a, b, c, d) {
      ...
      var h = !1,
        ...
        m = function () {
          ...
          w.background(!1, e.backgroundClassName, e.fade, g);
          f(D).off("resize.resize.dtb-collection");
      ...
      if (!1 === a) m();
        ...
        c.length &&
          (g.closest("div.dt-button-collection").length && (g = c.eq(0)), m());
        var k = f("<div/>")
          .addClass("dt-button-collection")
          .addClass(e.collectionLayout)
          .addClass(e.splitAlignClass)
          .css("display", "none");
        a = f(a).addClass(e.contentClassName).attr("role", "menu").appendTo(k);
        g.attr("aria-expanded", "true");
        g.parents("body")[0] !== z.body && (g = z.body.lastChild);
        e.popoverTitle
          ? k.prepend(
        ...
        I(k.insertAfter(g), e.fade);
        d = f(b.table().container());
        var t = k.css("position");
        "dt-container" === e.align &&
          ((g = g.parent()), k.css("width", d.width()));
        if ("absolute" === t) {
          var r = g.position();
          c = f(b.node()).position();
          k.css({
            top: f(f(b[0].node).parent()[0]).hasClass("dt-buttons")
              ? c.top + g.outerHeight()
              : r.top + g.outerHeight(),
            left: r.left,
          });
          r = k.outerHeight();
          var n = d.offset().top + d.height();
          n = c.top + g.outerHeight() + r - n;
          var l = c.top - r,
            p = d.offset().top;
          c = c.top - r - 5;
          (n > p - l || e.dropup) && -c < p && k.css("top", c);
          c = d.offset().left;
          d = d.width();
          d = c + d;
          r = k.offset().left;
          ...
          0 === n &&
            0 < k.children().length &&
            (n = f(k.children()[0]).outerWidth());
          n = r + n;
          var x = g.offset().left;
          p = g.outerWidth();
          l = x + p;
          if (
            k.hasClass(e.rightAlignClassName) ||
            k.hasClass(e.leftAlignClassName) ||
            k.hasClass(e.splitAlignClass) ||
            "dt-container" === e.align
          ) {
            var F = l;
            g.hasClass("dt-btn-split-wrapper") &&
              0 < g.children("button.dt-btn-split-drop").length &&
              ((x = g.children("button.dt-btn-split-drop").offset().left),
              (p = g.children("button.dt-btn-split-drop").outerWidth()),
              (F = x + p));
            p = 0;
            if (k.hasClass(e.rightAlignClassName))
              (p = l - n),
                c > r + p &&
                  ((c -= r + p), (d -= n + p), (p = c > d ? p + d : p + c));
            else if (k.hasClass(e.splitRightAlignClassName))
              (p = F - n),
                c > r + p &&
                  ((c -= r + p), (d -= n + p), (p = c > d ? p + d : p + c));
            else if (k.hasClass(e.splitLeftAlignClassName)) {
              if (((p = x - r), d < n + p || c > r + p))
                (c -= r + p), (d -= n + p), (p = c > d ? p + d : p + c);
            } else
              (p = c - r),
                d < n + p &&
            ...
            g.offset(),
              (p = 0),
              (p = "button-right" === e.align ? l - n : x - r);
          k.css("left", k.position().left + p);
        } else
          (t = function () {
            var C = f(D).height() / 2,
              y = k.height() / 2;
            ...
            t(),
            f(D).on("resize.dtb-collection", function () {
              t();
            });
        e.background &&
          w.background(
            !0,
            e.backgroundClassName,
            e.fade,
            e.backgroundHost || g
          );
        ...
        e.autoClose &&
          setTimeout(function () {
            b.on("buttons-action.b-internal", function (C, y, v, B) {
              B[0] !== g[0] && m();
            });
          }, 0);
        f(k).trigger("buttons-popover.dt");
        b.on("destroy", m);
        setTimeout(function () {
          h = !1;
          f("body")
            .on("click.dtb-collection", function (C) {
              if (!h) {
                var y = f.fn.addBack ? "addBack" : "andSelf",
                  v = f(C.target).parent()[0];
                ((!f(C.target).parents()[y]().filter(a).length &&
                  !f(v).hasClass("dt-buttons")) ||
  ...
  w.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      h = function (e) {
        if (Array.isArray(e)) for (var g = 0, m = e.length; g < m; g++) h(e[g]);
        else
          "string" === typeof e
            ? -1 !== e.indexOf(",")
              ? h(e.split(","))
  ...
  w.buttonSelector = function (a, b) {
    for (
      var c = [],
        d = function (m, k, t) {
          for (var r, n, l = 0, p = k.length; l < p; l++)
            if ((r = k[l]))
              (n = t !== q ? t + l : l + ""),
                m.push({ node: r.node, name: r.conf.name, idx: n }),
                r.buttons && d(m, r.buttons, n + "-");
        },
        h = function (m, k) {
          var t,
            r = [];
          d(r, k.s.buttons);
          var n = f.map(r, function (l) {
            return l.node;
          });
          if (Array.isArray(m) || m instanceof f)
            for (n = 0, t = m.length; n < t; n++) h(m[n], k);
          else if (null === m || m === q || "*" === m)
            for (n = 0, t = r.length; n < t; n++)
              c.push({ inst: k, node: r[n].node });
          else if ("number" === typeof m)
            k.s.buttons[m] && c.push({ inst: k, node: k.s.buttons[m].node });
          else if ("string" === typeof m)
            if (-1 !== m.indexOf(","))
              for (r = m.split(","), n = 0, t = r.length; n < t; n++)
                h(r[n].trim(), k);
            else if (m.match(/^\d+(\-\d+)*$/))
              (n = f.map(r, function (l) {
                return l.idx;
              })),
                c.push({ inst: k, node: r[f.inArray(m, n)].node });
            else if (-1 !== m.indexOf(":name"))
              for (m = m.replace(":name", ""), n = 0, t = r.length; n < t; n++)
                r[n].name === m && c.push({ inst: k, node: r[n].node });
            else
              f(n)
                .filter(m)
                .each(function () {
                  c.push({ inst: k, node: this });
                });
          else
            "object" === typeof m &&
              m.nodeName &&
              ((r = f.inArray(m, n)),
              -1 !== r && c.push({ inst: k, node: n[r] }));
        },
        e = 0,
        g = a.length;
      e < g;
  ...
  f.extend(A, {
    ...
    csv: function (a, b) {
      if (A.csvHtml5 && A.csvHtml5.available(a, b)) return "csvHtml5";
    },
    excel: function (a, b) {
      if (A.excelHtml5 && A.excelHtml5.available(a, b)) return "excelHtml5";
    },
    pdf: function (a, b) {
      if (A.pdfHtml5 && A.pdfHtml5.available(a, b)) return "pdfHtml5";
    },
        ...
        buttons: f.map(b, function (e, g) {
          return {
            ...
            init: function (m, k, t) {
              var r = this;
              k = function () {
                r.active(m.page.len() === e);
              };
              m.on("length.dt" + t.namespace, k);
              k();
            },
            destroy: function (m, k, t) {
              m.off("length.dt" + t.namespace);
            },
          };
        }),
        init: function (e, g, m) {
          var k = this;
          e.on("length.dt" + m.namespace, function () {
            k.text(m.text);
          });
        },
        destroy: function (e, g, m) {
          e.off("length.dt" + m.namespace);
        },
      };
    },
    spacer: {
  ...
  u.Api.register("button().add()", function (a, b, c) {
    var d = this.context;
    d.length &&
      ((d = w.instanceSelector(this._groupSelector, d[0]._buttons)),
      d.length && d[0].add(b, a, c));
  ...
  var K = function (a) {
    ...
    Q = function (a, b) {
      ...
      b = a
        ...
        .indexes()
        .map(function (p) {
          var x = a.column(p).header();
          return c.format.header(x.innerHTML, p, x);
        })
        .toArray();
      var d = a.table().footer()
          ? a
              ...
              .indexes()
              .map(function (p) {
                var x = a.column(p).footer();
                return c.format.footer(x ? x.innerHTML : "", p, x);
              })
              .toArray()
          : null,
        h = f.extend({}, c.modifier);
      a.select &&
        "function" === typeof a.select.info &&
        h.selected === q &&
        a.rows(c.rows, f.extend({ selected: !0 }, h)).any() &&
        f.extend(h, { selected: !0 });
      h = a.rows(c.rows, h).indexes().toArray();
      var e = a.cells(h, c.columns);
      h = e.render(c.orthogonal).toArray();
      e = e.nodes().toArray();
      for (
        var g = b.length, m = [], k = 0, t = 0, r = 0 < g ? h.length / g : 0;
        t < r;
        t++
      ) {
        for (var n = [g], l = 0; l < g; l++)
          (n[l] = c.format.body(h[k], t, l, e[k])), k++;
        m[t] = n;
      }
      b = { header: b, footer: d, body: m };
      c.customizeData && c.customizeData(b);
      return b;
    };
  f.fn.dataTable.Buttons = w;
  f.fn.DataTable.Buttons = w;
  f(z).on("init.dt plugin-init.dt", function (a, b) {
    "dt" === a.namespace &&
