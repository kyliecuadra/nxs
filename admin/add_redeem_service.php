...
$points_redeemed = isset($_POST['points_redeemed']) ? (int) $_POST['points_redeemed'] : 0;

// Validate input
if (empty($service_name) || $points_redeemed <= 0) {
...
$sql = "INSERT INTO points_configuration (service_name, points_acquired, points_redeemed) 
        VALUES ('$service_name', NULL, $points_redeemed)";
